...
#include <MotionController/Simulation/Top/SimulationTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
static void signalHandler(int signum) {
    MotionController::stopRateGroups();
}
...
int main(int argc, char* argv[]) {
    ...
    MotionController::TopologyState inputs;
    ...
    MotionController::setupTopology(inputs);
    MotionController::startRateGroups();
    MotionController::teardownTopology(inputs);
