module MotionController {
  ...
  deployment topology Simulation {
  ...
  # ----------------------------------------------------------------------
    ...
    # include "SimulationPackets.fppi"
  ...
  # ----------------------------------------------------------------------
    ...
    connections RateGroups {
      ...
      rateGroup_1Hz.RateGroupMemberOut[6] -> MotionController.controller.run
      rateGroup_1Hz.RateGroupMemberOut[7] -> MotionController.plant.run
    ...
    connections Simulation {
      ...
      MotionController.controller.controlOutput -> MotionController.plant.actuatorForce
      # Connect plant state to controller measurement input
      MotionController.plant.plantState -> MotionController.controller.measurement
    }
